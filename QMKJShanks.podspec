Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://github.com/flyand007/ShanksSDK/releases/download/1.2.4/QMKJShanks_Package.zip'
  }
...
s.dependency 'Adjust'
   ...
   s.dependency 'bigo-ads-admob-adapter','~> 5.0.0.0'
    s.dependency 'GoogleMobileAdsMediationPangle', '~> 7.7.0.6.0'
   ...
   s.dependency  'AppLovinMediationMintegralAdapter','~> 7.7.9.0'
   s.dependency  'AppLovinMediationUnityAdsAdapter', '~> 4.16.3.0'
   s.dependency 'AppLovinMediationVungleAdapter', '~> 7.6.1.0'
   ...
   s.dependency 'AppLovinMediationIronSourceAdapter', '~> 9.0.0.0.0'
   s.dependency 'AppLovinMediationByteDanceAdapter', '~> 7.7.0.6.0'
end
